...
class MovieDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => servicesLocator<MovieDetailsBloc>()..add(GetMovieDetailsEvent(id))..add(GetMovieRecommendationEvent(id)),
            ...
            return CustomScrollView(
              ...
              slivers: [
                SliverAppBar(
                  ...
                  imageUrl: AppConstance.urlImage(path: state.movieDetails!.backbropPath),
                          fit: BoxFit.cover,
                        ),
                      ),
                    ),
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                child: Text(
                                  state.movieDetails!.releaseData!.split('-')[0],
          ...
          final recommendation =state.movieRecommendation![index];
            return FadeInUp(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl: AppConstance.urlImage(path: recommendation.backdrobpath!),
